...

{
...

    {
        ...
        return view('pos.show-table', compact('categories','MenuCate', 'addons', 'menuCat', 'discountDetail', 'pos_table_id', 'menuAll', 'menuGr', 'tableStatus', 'order', 'orderDetail', 'payment', 'currency', 'posDetails', 'size'));
