...

{
    ...
    public function updateShop(Request $request, $S_id)
...

    {
        ...
        return view('setting.menu', compact('menuIngredients', 'invMenu', 'material', 'MenuCate', 'uom', 'size', 'currency', 'ingredientQty', 'dropdownMenu'));
    ...
    public function getMenuDetail (Request $request){
        ...
        $getMenuDetail = MenuDetail::orderBy('Menu_id')->paginate(8);
        $menuDetail = $getMenuDetail->getCollection()->groupBy('Menu_id');
