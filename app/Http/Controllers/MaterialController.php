            ...
            <tr class="' . $rowClass . ' text-base ' . $borderClass . ' text-center border-white">
                ...
                <td class="py-3 border border-white">
                    <button class="relative bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white py-2 px-4 rounded-md focus:outline-none transition duration-150 ease-in-out group"
                        onclick="openEditPopup(' . $data->Material_id . ', \'' . $data->Material_Khname . '\', \'' . $data->Material_Engname . '\', \'' . ($data->MaterialCategory->Material_Cate_Khname ?? 'null') . '\', \'' . $data->image . '\')">
                    ...
                    <button class="relative bg-red-500 hover:bg-red-600 active:bg-red-700 text-white py-2 px-4 rounded-md focus:outline-none transition duration-150 ease-in-out group"
                        onclick="confirmDelete(' . $data->Material_id . ')">
                        <i class="fas fa-trash-alt fa-xs"></i>
                    </button>
                    <button class="relative text-white py-2 px-4 rounded-md focus:outline-none transition duration-150 ease-in-out group"
                        onclick="toggleActive(this, ' . $data->Material_id . ')"
                        style="background-color: ' . ($data->status === 'Active' ? '#008000' : '#f00') . ';">
