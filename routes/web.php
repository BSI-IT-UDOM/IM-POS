...
use App\Http\Controllers\IngredientQtyController;
...
Route::get('/export-bill/{id}', [ExportController::class, 'exportBill'])->name('export.bill');
...
Route::patch('/setting/{S_id}', [SettingController::class, 'updateShop'])->name('updateShop');
...
Route::post('/create-menu-ingredient', [IngredientQtyController::class, 'store'])->name('create-menu-ingredient');
...
//sales detail
Route::get('/sales', [SalesController::class, 'saleDetail'])->name('sales');
Route::post('/sales', [SalesController::class, 'store'])->name('sales.store');
Route::get('/get-menu-price/{id}', function ($id) {
    $menuDetail = MenuDetail::where('Menu_id', $id)->first();
    return response()->json(['price' => $menuDetail ? $menuDetail->price : 0]);
});
